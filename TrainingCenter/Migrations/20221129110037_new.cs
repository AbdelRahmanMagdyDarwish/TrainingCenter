        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StudentSupervisor = table.Column<int>(type: "int", nullable: false),
                    SupervisorStudentId = table.Column<int>(type: "int", nullable: true),
                    DepartmentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Students_Students_SupervisorStudentId",
                        column: x => x.SupervisorStudentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_SupervisorStudentId",
                table: "Students",
                column: "SupervisorStudentId");
        }
